...
namespace Root.Reports
{
    ...
    /// </remarks>
    public class OpenTypeFontData : FontData
    {
        #region Constructor
        ...
        public OpenTypeFontData(FontDef fontDef, FontStyle fontStyle, Stream stream, FontTypeEnum fontType) : base(fontDef, fontStyle)
        {
            this.fontDef = fontDef;
            this.fontStyle = fontStyle;
            this.bEmbed = false;
            if (fontType == FontTypeEnum.TTC)
            {
                bTrueTypeCollection = true;
            }
            using (var openTypeReader = new OpenTypeReader(stream))
            {
